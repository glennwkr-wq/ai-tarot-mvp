...
async def start_handler(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        ...
        "Здесь нет жестких предсказаний —\n"
        "только интерпретации, которые помогают лучше понять себя и ситуацию.\n\n"
        "✨ Вы можете задать вопрос\n"
        "или просто посмотреть, что сейчас происходит в вашей жизни\n\n"
        "—\n\n"
        "Продолжая, вы подтверждаете, что вам исполнилось 18 лет\n"
        "и принимаете, что ответы носят интерпретационный характер\n"
        "и не являются абсолютной истиной.\n\n"
